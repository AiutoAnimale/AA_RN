        ...
        <View style={Styles.inputContainer}>
            ...
            {props.state == 'password' ? (
                <View style={Styles.pwConatiner}>
                    <TextInput style={Styles.pwInput} placeholder={props.innerText} secureTextEntry={props.pwState}></TextInput>
                    <TouchableOpacity style={Styles.btn} onPress={props.onPress}>
                        {props.pwState == false ? <ViewPwShow /> : <ViewPw />}
                    </TouchableOpacity>
                </View>
            ) : (
                <TextInput style={Styles.container} placeholder={props.innerText} secureTextEntry={false}></TextInput>
            )}
